...
enum Shader : int32_t {
	...
	SHADER_CR_CED_ALLOCATION_COMMANDER,
	...
	SHADER_CR_CPG_ALLOCATION_COMMANDER,
	SHADER_CR_CPG_ALLOCATION_L0_UP,
	SHADER_CR_CPG_ALLOCATION_L1_UP,
	SHADER_CR_CPG_ALLOCATION_L0_DOWN,
...
std::map<Shader, ShaderBuildInfo> shader_to_shader_info_map = {{
	...
	{ SHADER_CR_MP_SECOND_COMMANDER,              ShaderBuildInfo{"cr__mp__second_commander",              "./contour_rasterization/mesh_processing/second_commander.comp",           M_SHADER_STAGE_COMPUTE_BIT} },
	...
	{ SHADER_CR_CED_ALLOCATION_COMMANDER, ShaderBuildInfo{"cr__ced__allocation_commander", "./contour_rasterization/contour_edge_detection/allocation.comp",       M_SHADER_STAGE_COMPUTE_BIT, "-DCOMMANDER"} },
	...
	{ SHADER_CR_CPG_ALLOCATION_COMMANDER, ShaderBuildInfo{"cr_cpg_allocation_commander", "./contour_rasterization/contour_pixel_generation/allocation.comp",       M_SHADER_STAGE_COMPUTE_BIT, "-DCOMMANDER"} },
	{ SHADER_CR_CPG_ALLOCATION_L0_UP,     ShaderBuildInfo{"cr_cpg_allocation_l0_up",     "./contour_rasterization/contour_pixel_generation/allocation.comp",       M_SHADER_STAGE_COMPUTE_BIT, "-DLEVEL_0 -DUP_SWEEP"} },
	{ SHADER_CR_CPG_ALLOCATION_L1_UP,     ShaderBuildInfo{"cr_cpg_allocation_l1_up",     "./contour_rasterization/contour_pixel_generation/allocation.comp",       M_SHADER_STAGE_COMPUTE_BIT, "-DLEVEL_1 -DUP_SWEEP"} },
	{ SHADER_CR_CPG_ALLOCATION_L0_DOWN,   ShaderBuildInfo{"cr_cpg_allocation_l0_down",   "./contour_rasterization/contour_pixel_generation/allocation.comp",       M_SHADER_STAGE_COMPUTE_BIT, "-DLEVEL_0 -DDOWN_SWEEP"} },
