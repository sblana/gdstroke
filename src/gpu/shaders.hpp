...
enum Shader : int32_t {
	...
	SHADER_CR_FG_SCATTER_BRESENHAM,
	SHADER_CR_FG_SCATTER_DDA,
...
std::map<Shader, ShaderBuildInfo> shader_to_shader_info_map = {{
	...
	{ SHADER_CR_FG_SCATTER_BRESENHAM, ShaderBuildInfo{"cr__fg__scatter_bresenham", "./contour_rasterization/fragment_generation/scatter.comp",          M_SHADER_STAGE_COMPUTE_BIT, "-DRASTER_METHOD_BRESENHAM"} },
	{ SHADER_CR_FG_SCATTER_DDA,       ShaderBuildInfo{"cr__fg__scatter_dda",       "./contour_rasterization/fragment_generation/scatter.comp",          M_SHADER_STAGE_COMPUTE_BIT, "-DRASTER_METHOD_DDA"} },
