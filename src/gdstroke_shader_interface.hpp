...
public:
	...
	struct MeshInterfaceSet : InterfaceSet {
		enum Buffer : uint32_t {
			BUFFER_MESH_DESC_BUFFER = 0,
			BUFFER_VERTEX_BUFFER,
			BUFFER_EDGE_TO_VERTEX_BUFFER,
			BUFFER_EDGE_TO_FACE_BUFFER,
			BUFFER_EDGE_IS_CONCAVE_BUFFER,
			BUFFER_EDGE_IS_CONTOUR_BUFFER,
			BUFFER_EDGE_TO_CONTOUR_EDGE_BUFFER,
			BUFFER_ALLOCATION_COLUMN_EDGE_BUFFER,
			BUFFER_FACE_TO_VERTEX_BUFFER,
			BUFFER_FACE_NORMAL_BUFFER,
			BUFFER_FACE_BACKFACING_BUFFER,
			BUFFER_MAX,
		};
	...
	struct ContourInterfaceSet : InterfaceSet {
		enum Buffer : uint32_t {
			...
			BUFFER_CONTOUR_FRAGMENT_PIXEL_COORD_BUFFER,
			BUFFER_CONTOUR_FRAGMENT_ORIENTATION_BUFFER,
			BUFFER_CONTOUR_FRAGMENT_NORMAL_DEPTH_BUFFER,
			...
			BUFFER_CONTOUR_PIXEL_PIXEL_COORD_BUFFER,
			BUFFER_CONTOUR_PIXEL_ORIENTATION_BUFFER,
			BUFFER_CONTOUR_PIXEL_NORMAL_DEPTH_BUFFER,
			BUFFER_MAX,
		};
	...
	struct PixelEdgeInterfaceSet : InterfaceSet {
		enum Buffer : uint32_t {
			...
			BUFFER_SPARSE_PIXEL_EDGE_MORTON_CODE_BUFFER,
			BUFFER_SPARSE_PIXEL_EDGE_LOOP_BREAKING_BUFFER,
			BUFFER_SPARSE_PIXEL_EDGE_LIST_RANKING_BUFFER,
			BUFFER_SPARSE_PIXEL_EDGE_ASSOCIATED_HEAD_BUFFER,
			BUFFER_SPARSE_PIXEL_EDGE_IS_HEAD_BUFFER,
			BUFFER_SPARSE_PIXEL_EDGE_LOCAL_IDX_BUFFER,
			BUFFER_SPARSE_PIXEL_EDGE_TO_PIXEL_EDGE_LOOP_BUFFER,
			...
			BUFFER_COMPACTED_PIXEL_EDGE_MIDPOINTS_FILTERING_BUFFER,
