...
public:
	...
	struct MeshInterfaceSet : InterfaceSet {
		enum Binding : uint32_t {
			...
			BINDING_ALLOCATION_COLUMN_EDGE_BUFFER,
	...
	struct ContourInterfaceSet : InterfaceSet {
		enum Binding : uint32_t {
			...
			BINDING_CONTOUR_EDGE_IS_DISCARDED_BUFFER,
			BINDING_CONTOUR_EDGE_CLIP_T_BUFFER,
	...
	struct PixelEdgeInterfaceSet : InterfaceSet {
		enum Binding : uint32_t {
			...
			BINDING_COMPACTED_PIXEL_EDGE_TO_PIXEL_EDGE_LOOP_BUFFER,
			BINDING_COMPACTED_PIXEL_EDGE_MIDPOINTS_FILTERING_BUFFER,
			BINDING_COMPACTED_PIXEL_EDGE_FILTERED_MIDPOINT_BUFFER,
